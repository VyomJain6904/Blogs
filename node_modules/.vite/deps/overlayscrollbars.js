...
// node_modules/.pnpm/overlayscrollbars@2.10.1/node_modules/overlayscrollbars/overlayscrollbars.mjs
...
var getTrasformTranslateValue = (t2, n2) => `translate${isObject(t2) ? `(${t2.x},${t2.y})` : `${"Y"}(${t2})`}`;
...
var getStaticPluginModuleInstance = (t2) => T[t2];
var k = "__osOptionsValidationPlugin";
var R = `data-overlayscrollbars`;
var V = "os-environment";
var L = `${V}-scrollbar-hidden`;
var U = `${R}-initialize`;
var P = "noClipping";
var N = `${R}-body`;
var q = R;
...
var Q = `${R}-padding`;
var Z = `${R}-content`;
var tt = "os-size-observer";
var nt = `${tt}-appear`;
var ot = `${tt}-listener`;
var st = `${ot}-scroll`;
var et = `${ot}-item`;
var ct = `${et}-final`;
var rt = "os-trinsic-observer";
var lt = "os-theme-none";
var it = "os-scrollbar";
var at = `${it}-rtl`;
var ut = `${it}-horizontal`;
var _t = `${it}-vertical`;
var dt = `${it}-track`;
var ft = `${it}-handle`;
var pt = `${it}-visible`;
var vt = `${it}-cornerless`;
var ht = `${it}-interaction`;
var gt = `${it}-unusable`;
var bt = `${it}-auto-hide`;
var wt = `${bt}-hidden`;
var yt = `${it}-wheel`;
var St = `${dt}-interactive`;
var mt = `${ft}-interactive`;
...
var $t = (() => ({
  [Ot]: {
    static: () => (t2, n2, o2) => {
      const s2 = 3333333;
      const e2 = "scroll";
      const c2 = createDOM(`<div class="${et}" dir="ltr"><div class="${et}"><div class="${ct}"></div></div><div class="${et}"><div class="${ct}" style="width: 200%; height: 200%"></div></div></div>`);
      const r2 = c2[0];
...
var Ct = "__osScrollbarsHidingPlugin";
var xt = (() => ({
  [Ct]: {
    static: () => ({
      V: (t2, n2, o2, s2, e2) => {
        ...
        const _undoViewportArrange = (t3) => {
          if (u2) {
            ...
            const d2 = removeAttrClass(r2, F, W);
            setStyles(r2, a3);
            return [() => {
...
var createStructureSetupElements = (t2) => {
  ...
  let st2 = contents([nt2, tt2, K2, X2, W2].find(((t3) => t3 && !elementIsGenerated(t3))));
  const et2 = E2 ? W2 : nt2 || tt2;
  ...
  const appendElements = () => {
    ...
    focusElement(!H2 && h2 && n2 === W2 && t3.top === t3 ? tt2 : n2);
    c3();
    st2 = 0;
    return ct2;
  };
  return [Y2, appendElements, ct2];
};
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  return ({ It: n2, Zt: o2, _n: i2, Dt: a3 }, { fn: u3 }) => {
    ...
    const dt2 = u3 || b3 || y3 || it2 || rt2 || ot2 || et2 || j2 || B2 || X2;
...
export {
  Et as ClickScrollPlugin,
  OverlayScrollbars,
  xt as ScrollbarsHidingPlugin,
